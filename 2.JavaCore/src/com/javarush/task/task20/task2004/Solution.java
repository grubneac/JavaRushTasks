...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (classWithStatic.hashCode()==loadedObject.hashCode()) System.out.println("Ура!!!");
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String fullString=this.i+"\n";
            fullString+=this.j+"\n";
            fullString+=staticString+"\n";
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            this.i =Integer.parseInt(bufStr[0]);
            this.j = Integer.parseInt(bufStr[1]);
            staticString = bufStr[2];
        }
